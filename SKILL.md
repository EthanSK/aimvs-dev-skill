...
4. Test the smallest high-value set of flows that proves the requested behavior. Inspect actual screenshot pixels,
   emulator state, frontend/API/emulator logs, and relevant UI state; do not infer visual correctness from DOM or
   Accessibility state.
